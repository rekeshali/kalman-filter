...
function ParameterControls({ parameters, onParameterChange, onSplashFrequencyStart, onSplashFrequencyEnd, onSplashAmplitudeStart, onSplashAmplitudeEnd, splashProgress }) {
  ...
  return (
    <div className="space-y-3">
      {/* Wave Parameters */}
      <div className="rounded p-3 shadow-lg" style={{width: '304px', background: 'linear-gradient(135deg, rgba(255,255,255,0.05) 0%, transparent 50%), linear-gradient(135deg, rgb(31, 41, 55), rgb(15, 23, 42))'}}>
