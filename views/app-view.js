        ...
        <div className="flex-1 flex gap-4 px-24 py-4 overflow-hidden bg-gray-900">
          ...
          <div className="flex-1 overflow-x-auto pr-2" style={{maxHeight: 'calc(100vh - 120px)', minWidth: 0, overflowY: 'scroll'}}>
            ...
            >
              ...
              <div className="md:col-span-2 h-80 border border-gray-600 bg-gradient-to-br from-gray-800 to-slate-900 rounded-lg shadow-lg p-3">
                <ChartCanvas ref={positionChartRef} />
              </div>

              {/* Row 2: Acceleration | Velocity */}
              <div className="h-64 border border-gray-600 bg-gradient-to-br from-gray-800 to-slate-900 rounded-lg shadow-lg p-3">
